 ...
 */
public class SenHighFreqGN implements FeatCalculator<Double, TrainingExample, TrainingCtx> {

    private static Logger logger = Logger.getLogger(DepthOfContext.class);

    static Dictionary dic = null;

    public SenHighFreqGN() {
        try {
    ...
    public static TreeMap<String, Integer> SortByValue
        ...
        ValueComparatorSenHighFreqGN vc =  new ValueComparatorSenHighFreqGN(map);
        TreeMap<String,Integer> sortedMap = new TreeMap<String,Integer>(vc);
        sortedMap.putAll(map);
        return sortedMap;
    }
}
class ValueComparatorSenHighFreqGN implements Comparator<String> {

    Map<String, Integer> map;

    public ValueComparatorSenHighFreqGN(Map<String, Integer> base) {
        this.map = base;
    }
