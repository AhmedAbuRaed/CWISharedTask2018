 ...
 */
public class SenSumHighFreqGN implements FeatCalculator<Double, TrainingExample, TrainingCtx> {

    private static Logger logger = Logger.getLogger(DepthOfContext.class);

    static Dictionary dic = null;

    public SenSumHighFreqGN() {
        try {
    ...
    public static TreeMap<String, Integer> SortByValue
        ...
        ValueComparatorSenSumHighFreqGN vc = new ValueComparatorSenSumHighFreqGN(map);
...
class ValueComparatorSenSumHighFreqGN implements Comparator<String> {

    Map<String, Integer> map;

    public ValueComparatorSenSumHighFreqGN(Map<String, Integer> base) {
        this.map = base;
    }
