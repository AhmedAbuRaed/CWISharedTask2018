 ...
 */
public class SenSumLowFreqGN implements FeatCalculator<Double, TrainingExample, TrainingCtx> {
	
    private static Logger logger = Logger.getLogger(DepthOfContext.class);

    static Dictionary dic = null;

    public SenSumLowFreqGN() {
        try {
    ...
    public static TreeMap<String, Integer> SortByValue
        ...
        ValueComparatorSenSumLowFreqGN vc =  new ValueComparatorSenSumLowFreqGN(map);
        TreeMap<String,Integer> sortedMap = new TreeMap<String,Integer>(vc);
        sortedMap.putAll(map);
        return sortedMap;
    }
}
class ValueComparatorSenSumLowFreqGN implements Comparator<String> {

    Map<String, Integer> map;

    public ValueComparatorSenSumLowFreqGN(Map<String, Integer> base) {
        this.map = base;
    }
