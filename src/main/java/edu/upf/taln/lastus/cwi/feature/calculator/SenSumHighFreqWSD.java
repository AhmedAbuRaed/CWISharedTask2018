 ...
 */
public class SenSumHighFreqWSD implements FeatCalculator<Double, TrainingExample, TrainingCtx> {

    private static Logger logger = Logger.getLogger(DepthOfContext.class);

    static Dictionary dic = null;

    public SenSumHighFreqWSD() {
        try {
    ...
    public MyDouble calculateFeature(TrainingExample obj, TrainingCtx doc) {
        ...
        try {
            ...
            value.setValue(getPercentage(high, total));
    ...
    public static TreeMap<String, Integer> SortByValue
        ...
        ValueComparatorSenSumHighFreqWSD vc = new ValueComparatorSenSumHighFreqWSD(map);
...
class ValueComparatorSenSumHighFreqWSD implements Comparator<String> {

    Map<String, Integer> map;

    public ValueComparatorSenSumHighFreqWSD(Map<String, Integer> base) {
        this.map = base;
    }
