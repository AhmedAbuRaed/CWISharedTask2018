 ...
 */
public class SenLowFreqWSD implements FeatCalculator<Double, TrainingExample, TrainingCtx> {

    private static Logger logger = Logger.getLogger(DepthOfContext.class);

    static Dictionary dic = null;

    public SenLowFreqWSD() {
        try {
    ...
    public static TreeMap<String, Integer> SortByValue
        ...
        ValueComparatorSenLowFreqWSD vc = new ValueComparatorSenLowFreqWSD(map);
...
class ValueComparatorSenLowFreqWSD implements Comparator<String> {

    Map<String, Integer> map;

    public ValueComparatorSenLowFreqWSD(Map<String, Integer> base) {
        this.map = base;
    }
